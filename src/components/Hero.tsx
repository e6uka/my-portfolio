...
const Hero: React.FC = () => {
  ...
  return (
    <section
      ...
      <div className="max-w-6xl relative z-10 flex items-center min-h-screen w-full">
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6 flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
              <span className={creativeTextClass}>
                Creative
              </span>
              <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-blue-400 bg-clip-text ">
                <RotatingText
                  texts={["Code", "Apps", "Websites", "Logic"]}
